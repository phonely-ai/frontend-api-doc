...
You can click any outcome, group, or chart segment to see the specific calls that produced that result.

For example:

Clicking the **Appointment Booked** group will open a list showing:
...
This allows you to move beyond analytics and understand real caller behavior.

---

## Example: Measuring Appointment Conversion Rate

Scenario: You want to measure how many calls resulted in booked appointments.

Steps:

1. Set post-call outcomes using `"Appointment Booked"`
2. Go to **Analytics → Performance**
3. Set date range (for example, Last 30 days)
4. Click **Group**
5. Create group: `Appointment Booked`
6. Create group: `All Calls`
7. Switch chart to **Percentage**

You can now see:

- Percentage of calls resulting in appointments
- Trends over time
- Whether your agent is improving or declining

You can also click the group to review individual calls.