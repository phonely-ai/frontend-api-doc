...
sources:
  ...
  - "phonely-backend/app/models/flow_blocks/google_drive_block_model.py"
  - "phonely-backend/app/agent/live_actions/file_upload/file_upload.py"
  - "phonely-backend/app/agent/live_actions/file_upload/google_drive.py"
