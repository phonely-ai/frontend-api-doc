...
sources:
  ...
  - "features/workflows/ai/prompt/build-allowed-block-types.ts"
  ...
  - "app/models/flow_blocks/slack_block_model.py"
  - "app/agent/live_actions/messaging/slack.py"
  - "app/agent/live_actions/messaging/messaging.py"
