...
Across a Transfer Flow, an inbound target flow can import a [Flow Input](/flow-editor/variables#use-flow-inputs) to reuse a value the source flow collected earlier in the same call.
