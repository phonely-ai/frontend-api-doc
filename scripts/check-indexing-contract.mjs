...
const EXPECTED_SEARCHABLE_PAGES = [
  ...
  'blocks/live-call-integrations/microsoft-outlook',
  'blocks/live-call-integrations/slack',
  'blocks/live-call-integrations/zapier-live',
  'blocks/post-call-actions/send-call-data',
  'blocks/post-call-actions/sms-and-email-notifications',
  'key-concepts/advanced-variables',
  'key-concepts/auto-gather-variables',
  'key-concepts/flow-canvas-controls',
  'key-concepts/manage-workflow-versions',
  'key-concepts/replace-invalid-variables',
