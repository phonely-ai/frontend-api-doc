...
{/* TODO: Replace with an updated screenshot of the Voice Settings panel. The captured version still shows the removed Multi-Lingual toggle; the panel is now Speed, Languages, Background Noise, Pronunciations, and Advanced. */}
{/* TODO: Remove old asset /assets/voice-library-and-settings.png once the replacement is added. */}
