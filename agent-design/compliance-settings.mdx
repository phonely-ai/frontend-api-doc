...
<Columns cols={2}>
  ...
  <Column>
    <Card title="When disabled" icon="lasso-select">
      Calls are not recorded, but transcripts will still be generated using Phonely’s speech-to-text engine. Useful for organizations that want conversational insight without retaining audio files.
    </Card>
  </Column>
</Columns>

- Full audio recordings are captured and stored securely.
- **When disabled** 
