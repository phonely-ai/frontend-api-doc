...
sources:
  - "app/(main)/(routes)/agent/(routes)/[agentId]/components/content/agent-settings/components/setting-tabs/compliance-tab.tsx"
...
<Steps>
  ...
  <Step title="Click the Compliance tab.">
  </Step>
  <Step title="Each option can be enabled or disabled depending on your operational needs.">
  </Step>
</Steps>
