...
3. Each option can be enabled or disabled depending on your operational needs. <img src="/assets/compliance-settings-phonely.gif" alt="Compliance Settings Phonely Gi" />
...
<Columns cols={2}>
  ...
  <Column>
    <Card title="When disabled" icon="lasso-select">
      Calls are not recorded, but transcripts will still be generated using a speech-to-text engine. Get conversational insight without retaining audio files.
    </Card>
  </Column>
</Columns>

- Full audio recordings are captured and stored securely fix the broken alink and allow us to generate the required transcripts. 
