...
- `/llms.txt` and `/llms-full.txt`: auto-generated by Mintlify at serve time from navigation — do NOT commit an `llms.txt` to this repo, a committed copy overrides and freezes the auto-generated one
