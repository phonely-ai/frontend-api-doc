---
title: "Webhook"
description: "Receive webhook data before a call starts and use it in the workflow."
sources:
...
<Steps>
  ...
  <Step title="Add the Action">
    ...
    <Frame>
      ![Chooseprecallaction](/images/chooseprecallaction.png)
    </Frame>
  </Step>
  ...
  <Step title="Choose the Webhook Action Type">
    ...
    <Frame>
      ![Selectcustomwebhook](/images/selectcustomwebhook.png)
    </Frame>
