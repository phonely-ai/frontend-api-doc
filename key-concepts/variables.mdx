...
<img
  src="/assets/type-and-untyped-variables.png"
  alt="Type And Untyped Variables"
  title="Type And Untyped Variables"
  style={{ width:"61%" }}
/>
...
{/* TODO: Add a short GIF showing the full variable lifecycle: (1) typing @ to insert a variable in a Talk block prompt, (2) the auto-gather prompt appearing during a test call, (3) the variable value being used in an API request body. This "show the flow" visual connects the concept tables above to real usage. */}
...
![Reorder Variables](/assets/reorder-variables.png)
