...
{/* TODO: Add a hero GIF (~8s) showing the flow builder in action — dragging blocks, connecting them, and the resulting conversation flow. This is the core product surface. Mintlify places product screenshots inside <Frame> with light/dark variants right after the intro text. A looping GIF of someone building a simple 3-block flow would be perfect. */}
...
{/* TODO: Add a GIF showing the "Test from here" feature — right-clicking a block, selecting "Test from here," and hearing the agent respond. This is a unique feature and showing it visually would be a strong selling point. */}
