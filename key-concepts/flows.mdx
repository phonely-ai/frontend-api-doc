...
## Ask AI in the Workflow Builder

Use **Ask AI** directly in the workflow builder to get help with your flow. The AI understands the context of your current workflow and can assist with:

- Generating new blocks or entire flows from natural language descriptions
- Explaining what existing blocks do
- Suggesting improvements to your conversation logic
- Debugging issues in your flow

To use Ask AI:

1. Open any workflow in the builder.
2. Click the **Ask AI** button in the canvas toolbar.
3. Type your question or request in natural language.
4. The AI will respond with context-aware suggestions based on your current workflow.

<Frame>
  {/* TODO: Add GIF showing Ask AI in workflow builder - opening the AI panel, asking a question about a flow, and applying the suggested changes. */}
</Frame>

<Tip>
  Ask AI has full context of your current workflow including block types, connections, and variables, so you can ask specific questions like "Add a Collect block after the greeting to ask for the caller's name."
</Tip>
...
<Tip>
  Some examples of tags that you can use include: **appointment\_scheduled**, **lead\_qualified,** **customer\_satisfied, escalation\_needed, no\_show\_followup**, etc.
</Tip>
