...
<img
  src="/assets/block-edge-tool-tip.png"
  alt="Block Edge Tool Tip"
  title="Block Edge Tool Tip"
  style={{ width:"96%" }}
/>
...
<img
  src="/assets/new-agent-design-view.png"
  alt="New Agent Design View"
  title="New Agent Design View"
  style={{ width:"67%" }}
/>
...
<img
  src="/assets/select-copy-and-paste.png"
  alt="Select Copy And Paste"
