...
Select **Collapse all blocks** to hide the detailed exit-condition sections on blocks that support them. Select **Expand all blocks** to show those sections again.

This changes only how the canvas is displayed. It does not remove exit conditions, connections, or other block settings.
