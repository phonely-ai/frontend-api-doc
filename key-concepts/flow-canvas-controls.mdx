...
The toolbar provides quick-access actions that help you build, organize, and edit workflows efficiently without switching context. These tools affect **how you work on the canvas**, not how the flow executes at runtime.
