...
4. Fill in the required fields. These help your workflow understand exactly what to capture.
...
<Expandable title="Required Fields" defaultOpen="true">
...
<img
  src="/assets/custom-type-auto-gather-variables.png"
  alt="Custom Type Auto Gather Variables"
  title="Custom Type Auto Gather Variables"
  style={{ width:"59%" }}
/>
