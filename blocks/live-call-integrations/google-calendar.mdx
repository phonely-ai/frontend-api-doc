...
description: "Learn how to connect your google calendar, check availability slots and book appointments during calls"
---
...
<img
  src="/assets/connect-to-google-calendar.png"
  alt="Connect To Google Calendar Pn"
  title="Connect To Google Calendar Pn"
  style={{ width:"91%" }}
/>
...
<img
  src="/assets/selecting-google-permissions-for-phonely.png"
  alt="Selecting Google Permissions For Phonely Pn"
  title="Selecting Google Permissions For Phonely Pn"
  style={{ width:"92%" }}
/>
...
<Steps>
  <Step title="Calendar ID">
    ...
    <Tip>
      Use a dedicated “Bookings” calendar so customer appointments don’t mix with your personal events
    </Tip>
  </Step>
  ...
  <Step title="Available Time Slots (count)">
  ...
  <Step title="Available Times (per-day windows)">
...
<Steps>
  <Step title="End Time">
    Defines when the scheduled event ends. Must be later than the start time.
  </Step>
  <Step title="Email">
    Required field where you enter the attendee’s email.

    The system automatically sends a Google Calendar invitation to this address once the booking is created. You can use dynamic variables (e.g., caller email) captured earlier in the flow.
  </Step>
  <Step title="Appointment Name">
  ...
  <Step title="Appointment Description">
    A short summary of what the appointment is about. Appears inside the calendar event’s description field.
...
Shows a table of available slots. Each row includes Start Time \> End Time pairs.
