...
- **No engagement outcome:** The outcome recorded when the call ends before the caller engages with the agent. It defaults to **Greeting Hangup** and can be edited. This setting is under **Advanced Settings**.
