...
- **Call Context:** Optional caller identity and reason for calling. When an automated call screener answers, Phonely uses this context to respond. **Caller Name** and **Reason for Calling** can use variables available before the call begins.
