...
- CRM logging → Store @reason for support ticket routing Advanced Options

**Validation & Format Control**\
Regular expression & custom types allow enforcing patterns (emails, numbers, state codes).
