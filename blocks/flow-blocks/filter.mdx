...
<Frame>
  <img
    src="/assets/casefiltersblock.png"
    alt="Casefiltersblock"
    title="Casefiltersblock"
  />
</Frame>
...
A case represents a distinct route your flow can take. For example, _Case 1_ might handle verified callers, while _Case 2_ handles unverified callers. Use **➕ Add Case** to create a new case with its own set of conditions.
