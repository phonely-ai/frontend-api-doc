...
{/* TODO: Add a short GIF showing the "Generate with AI" experience — typing a natural language description, clicking generate, and seeing the prompt + exit conditions + variables auto-populate. This is a wow moment that should be shown, not just described. */}
...
<img
  src="/assets/call-outcome-tagging-talk-block.png"
  alt="Call Outcome Tagging Talk Block"
  title="Call Outcome Tagging Talk Block"
  style={{ width:"91%" }}
/>
