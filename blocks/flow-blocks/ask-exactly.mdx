...
ONLY use the Ask Exactly block when you'd like to ask a specific question. If you want the agent ask questions in a conversational manner and have a back & forth conversation, use the [Talk Block](/blocks/talk).

<Danger>
  **Note:** The **Ask Exactly** block is restricted to **admin users only**. If you don’t see these options, you may not have the required permissions.
</Danger>
