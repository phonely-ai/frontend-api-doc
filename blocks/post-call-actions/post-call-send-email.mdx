...
<img
  src="/assets/send-email-post-call-1.png"
...
3. **Action 2 (Post Call Send Email Block)**:
   1. Recipient: [email@example.com](mailto:email@example.com) (or select customer_email variable for customer notifications).
