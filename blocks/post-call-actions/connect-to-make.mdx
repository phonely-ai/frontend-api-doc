...
sources:
  ...
  - "features/workflows/modules/editor/custom-nodes/make/**"
...
(Optional) Enable Send full call data to Make if you want to send all available details such as:
...
1. Click **Continue** and test the webhook.
