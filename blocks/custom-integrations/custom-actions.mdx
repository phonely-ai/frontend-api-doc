...
Start by gathering the caller’s preferred date or time.

Add a **Talk** or **Collect** block to ask something like:
...
<img
  src="/assets/appointment-date-custom-action.png"
  alt="Appointment Date Custom Action"
  title="Appointment Date Custom Action"
  style={{ width:"89%" }}
/>
...
<img
  src="/assets/get-availability-custom-action.png"
  alt="Get Availability Custom Action"
  title="Get Availability Custom Action"
  style={{ width:"90%" }}
/>

### Let the Caller Choose a Slot

Add another **Talk** or **Collect** block to present the options:

> “I have availability at 10 AM or 2 PM. Which works for you?”

Store the result in a variable such as `selected_slot`.
...
<img
  src="/assets/make-appointment-custom-action.png"
  alt="Make Appointment Custom Action"
  title="Make Appointment Custom Action"
  style={{ width:"92%" }}
/>
