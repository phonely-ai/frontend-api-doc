---
title: "Custom Actions: Build Once, Reuse Everywhere"
...
- **Mantainability:** Update logic in one place, changes automatically propagate to all flows using that action.
...
![How To Create A Custom Action Gi](/assets/how-to-create-a-custom-action.gif)
...
Click the button below the smartt noode

<img
  src="/assets/add-blocks-to-a-custom-action.png"
  alt="Add Blocks To A Custom Action Pn"
  style={{ width:"84%" }}
/>
...
Choose the Check Availability action.

[Learn how you can connect phonely with your google calendar here](/blocks/live-call-integrations/google-calendar)
...
<img
  src="/assets/check-availability-custom-action.png"
  alt="Check Availability Custom Action Pn"
  title="Check Availability Custom Action Pn"
  style={{ width:"90%" }}
/>
...
![Managing Output Nodes Gi](/assets/managing-output-nodes.gif)
