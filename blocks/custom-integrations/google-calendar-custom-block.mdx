...
Define how long each appointment slot should be. For example you can enter: `15m, 30m, or 1h 30m etc`

This value determines how each time slot is generated and displayed to the caller.
