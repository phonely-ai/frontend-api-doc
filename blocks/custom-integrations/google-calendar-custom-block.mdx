...
Define how long each appointment slot should be.

Examples you can enter: `15m, 30m, or 1h 30m etc`

This value determines how each time slot is generated and displayed to the caller.2. Event Title

Enter the title that should appear on the Google Calendar event.
