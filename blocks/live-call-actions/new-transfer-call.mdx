...
{/* TODO: Add a short GIF (~8s) showing a warm transfer in action on the flow builder — the block being configured, a test call being placed, and the handoff happening. This is one of the most complex blocks and a visual walkthrough would dramatically reduce support questions. */}
