...
<img
  src="/assets/api-request-advanced-settings-and-outcome-tagging-1.png"
  alt="Api Request Advanced Settings And Outcome Tagging 1"
  title="Api Request Advanced Settings And Outcome Tagging 1"
  style={{ width:"67%" }}
/>
