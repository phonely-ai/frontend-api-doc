...
1. In your Flow Editor, locate the block where the API call should occur, then click the ➕ (plus) icon directly beneath or next to it.
...
<img
  src="/assets/advanced-settings-api-config-1.png"
  alt="Advanced Settings Api Config 1"
  title="Advanced Settings Api Config 1"
  style={{ width:"63%" }}
/>
