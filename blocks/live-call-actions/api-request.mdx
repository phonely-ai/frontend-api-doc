...
<Steps>
  <Step title="API Method" titleSize="p">
  ...
  <Step title="Headers" titleSize="p">
  ...
  <Step title="Query Parameters" titleSize="p">
    Use this if your API uses query strings in the URL (e.g., filtering or pagination).
  </Step>
  <Step title="Body (For POST, PUT, PATCH Requests)" stepNumber={5} titleSize="p">
