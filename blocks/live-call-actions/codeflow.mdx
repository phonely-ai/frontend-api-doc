...
<Steps>
  <Step title="Add a New Block" titleSize="p">
    From your workflow canvas, click the **\+** icon and select Code action from the list of available blocks.
  ...
  <Step title="Configure Input Variables">
    ...
    <img
      src="/assets/variables-in-code-block.png"
      alt="Selectinginputvariblesforpythoncodeblocks Pn"
      style={{ width:"96%" }}
    />
