...
{/* TODO: Add a GIF or screenshot sequence showing the payment flow in action — adding the block, configuring Braintree, and a test caller entering card details. Payment is a high-trust feature; seeing it work builds confidence. Also consider a diagram showing the secure payment isolation: Call Flow → [Secure PCI Environment] → Back to Call Flow. */}
