...
<AccordionGroup>
  ...
  <Accordion title="Data is unavailable after the transfer">
    Variables created in the source flow are not carried automatically into the target flow. Import a [Flow Input](/flow-editor/variables#use-flow-inputs) for the value in the target flow, or collect or retrieve it again within the target flow.
  </Accordion>
</AccordionGroup>
