...
| [Campaign](/blocks/communication-blocks/campaign) | Add the caller to an outbound campaign | Post-call |
...
| [Vision](/blocks/data-and-automation-blocks/vision) | Perform a task on a webpage | Live call |
...
| [Google Sheets](/integrations/google-sheets) | Search for or add a row in Google Sheets | Live call, post-call |
| [Google Drive](/integrations/google-drive) | Upload the call recording to Google Drive | Post-call |
...
| [Make](/integrations/make) | Send call data to Make | Post-call |
| [Zapier](/integrations/zapier) | Send call data to Zapier | Post-call |

Use Gmail or Microsoft Outlook when email should come from a connected provider account. Use [Send Email](/blocks/communication-blocks/send-email) for Phonely's built-in email action.

Integration blocks may appear before their connection is configured. Complete the required connection or webhook setup before testing or publishing. Each guide covers setup, configuration, testing, variables, and troubleshooting.
