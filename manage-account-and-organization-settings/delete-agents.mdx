...
sources:
  ...
  - "app/(main)/(routes)/agent/(routes)/[agentId]/components/content/agent-settings/components/delete-agent-modal.tsx"
---
...
<Steps>
  ...
  <Step title="Switch to the agents page.">
    <Frame>
      ![Delete agents settings](/assets/delete-agents-settings.png)
    </Frame>
  </Step>
