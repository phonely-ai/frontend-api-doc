...
<Frame>
  ![Fixnodeerrors](/assets/fixnodeerrors.png)

  1. 3. Re-check the node card, publish warnings should clear once required fields are valid.
  2. 4. Open the **Flow checklist** again to confirm the error count is reduced or gone.
  3. ![Fixedworkflowchecklisterrors](/assets/fixedworkflowchecklisterrors.png)
</Frame>