...
- **Filter** to block risky or ineligible callers
- **API request** to check account or eligibility status
- **Code** to apply custom validation logic
- **Webhook **to receive data from webhooks
...
## When to Use a Pre-Call End Call
