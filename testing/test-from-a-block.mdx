...
description: "Lear how to run and validate workflows starting from any block"
---

The Test from a block feature lets you run and validate a call flow starting from any block, without triggering the entire workflow from the beginning.
