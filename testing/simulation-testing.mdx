...
description: "Test your AI agents with fully synthetic, AI-generated phone conversations before real customers ever call"
---
...
<Steps>
  <Step title="Go to your Phonely Dashboard.">
  </Step>
  <Step title="Click the Simulation Testing tab at the top (beside A/B Testing).">
  </Step>
  <Step title="You will see two sub-tabs:">
    - **Test Cases** – Create and configure simulations.
    - **Results** – Review past simulation outputs.
  </Step>
  <Step title="The main screen shows:">
...
<Steps>
  <Step title="Go to Simulation Testing > Test Cases.">
  </Step>
  <Step title="Click the + card.">
  </Step>
  <Step title="A modal window titled Add Test Case will appear.">
    <img
      src="/assets/add-test-form.png"
      alt="Add Test Form"
      style={{ width:"94%" }}
    />
  </Step>
  <Step title="Fill in the following details:">
    **Case Name**
...
<Steps>
  <Step title="Click Add Evaluator and give it a name.">
  </Step>
  <Step title="Choose a conversation style ">
    Such as Casual, Angry, Frustrated, Happy, Distracted, Sad, or Demanding
  </Step>
  <Step title="Write detailed instructions, this defines how the evaluator behaves">
    Example: _“Act like a customer trying to book a flight but constantly changing their mind.”_
  </Step>
  <Step title="Define the success criteria">
...
<Steps>
  <Step title="Find the test card">
  </Step>
  <Step title="Click Run">
  </Step>
  <Step title="Phonely will begin generating simulated calls">
  </Step>
  <Step title="Progress indicators will appear">
