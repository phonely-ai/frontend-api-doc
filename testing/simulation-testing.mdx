...
- AI Evaluators (AI-generated callers)

Each of these appears as a tab at the top-right of the Data Sources panel.

You can attach one data source or mix multiple types depending on how complex your test case is.
...
3. Choose **Inbound** or **Outbound**
   - Inbound means the agent speaks first
   - Outbound means the customer speaks first
4. Drag or browse to add audio files
5. Press **Upload**

Uploaded recordings appear in a list. Select the checkboxes to attach them to a test case.

Phonely automatically transcribes and uses the audio during the simulation.
...
AI Evaluators are the most advanced and flexible data source.\
Instead of using audio recordings, an evaluator _acts_ as the customer during simulation.
