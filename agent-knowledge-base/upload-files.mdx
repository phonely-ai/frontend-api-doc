...
<Steps>
  ...
  <Step title="Click “Upload File”">
    At the top of the page, click **Upload File**.                     \
    A file upload window will appear, showing supported formats.
  ...
  <Step title="Verify and Activate">
    After uploading, your file will appear in the **Data Sources** list.        \
    Make sure the **Active** toggle is turned on so your agent can access this document.                       
